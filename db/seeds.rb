...
peacewithhonor = Track.create!(
  ...
  audio: File.open('app/assets/sounds/Peace_With_Honor.wav')
)
...
resignation = Track.create!(
  ...
  audio: File.open('app/assets/sounds/Nixon_Resigns.mp3')
)
...
ichbineinberliner = Track.create!(
  ...
  audio: File.open('app/assets/sounds/Ich_Bin_Ein_Berliner.mp3')
)
